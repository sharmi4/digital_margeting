...
class ORMStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Online Reputation Management expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Online Reputation Management strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
...
[
  {
    "day": 1,
    "title": "Online Reputation Management Audit",
    "instructions": [
