...
class ChatbatMStrategyApiService {
  final Dio _dio = Dio();
  final String apiKey =
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Chatbot Marketing expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Chatbot Marketing strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
