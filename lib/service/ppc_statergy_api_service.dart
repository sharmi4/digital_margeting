...
class PPCStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Pay-Per-Click Advertising expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Pay-Per-Click Advertising strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
...
[
  {
    "day": 1,
    "title": "Pay-Per-Click Advertising Audit",
    "instructions": [
