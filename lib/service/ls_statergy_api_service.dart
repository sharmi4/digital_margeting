...
class LSStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Local SEO expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Local SEO strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
