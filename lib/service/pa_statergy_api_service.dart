...
class PAStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Programmatic Advertising expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Programmatic Advertising strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
...
[
  {
    "day": 1,
    "title": "Programmatic Advertising Audit",
    "instructions": [
