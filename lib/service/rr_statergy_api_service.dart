...
class RRStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Remarketing / Retargeting expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Remarketing / Retargeting strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
...
[
  {
    "day": 1,
    "title": "Remarketing / Retargeting Audit",
    "instructions": [
