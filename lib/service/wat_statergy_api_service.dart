...
class WATStrategyApiService {
  ...
  Future<String?> sendToGemini() async {
    try {
      final prompt = '''
"You are an Web Analytics and Tracking expert. I need a structured and exact ${Helper.duration} task for ${Helper.duration}-day Web Analytics and Tracking strategy to generate leads for a web design business targeting both B2B and B2C in local and international markets
...
[
  {
    "day": 1,
    "title": "Web Analytics and Tracking Audit",
    "instructions": [
