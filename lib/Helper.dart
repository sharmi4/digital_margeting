...
class Helper {
 ...
 static List<ResponseModel> content = [];

 
 static String businessname  ="";
 static String businesscategoryselected = "";
 static String autiencetype = "";
 static String targetlocation = "";
 static String selectgoal = "";
 static List<TaskItem1> item = [];

 static String selectedstartergytitle ="";
