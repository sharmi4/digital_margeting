...
class StrategySelectionListScreen extends StatefulWidget {
  const StrategySelectionListScreen({super.key});

  @override
  State<StrategySelectionListScreen> createState() =>
      _StrategySelectionListScreenState();
}

class _StrategySelectionListScreenState extends State<StrategySelectionListScreen> {
