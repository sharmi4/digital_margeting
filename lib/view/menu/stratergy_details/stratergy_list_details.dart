...
import 'stratergy_list_screen.dart';

class StratergyListDetailsScreen extends StatefulWidget {
  StratergyListDetailsScreen({super.key});

  @override
  State<StratergyListDetailsScreen> createState() =>
      _StratergyListDetailsScreenState();
}

class _StratergyListDetailsScreenState
    extends State<StratergyListDetailsScreen> {
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: primaryFont(
                  ...
                  fontSize: 14,
                  height: 14.64 / 14,
                  // Flutter uses line-height as a multiplier
                  letterSpacing: -0.13,
                ),
                border: InputBorder.none,
                filled: true,
                fillColor: Colors.transparent,
                // So container color shows
