...
class VSOParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<VSOParticulartaskProgressScreen> createState() =>
      _VSOParticulartaskProgressScreenState();
}

class _VSOParticulartaskProgressScreenState
    extends State<VSOParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.vsoselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.vsotaskId}");
                DatabaseHelper().updateVSOtask(
                  SeoTaskModel(
                    id: Helper.vsotaskId,
                    taskname: Helper.vsoselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.vsosnumber,
