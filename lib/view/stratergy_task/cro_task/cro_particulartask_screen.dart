...
class CROParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<CROParticulartaskProgressScreen> createState() =>
      _CROParticulartaskProgressScreenState();
}

class _CROParticulartaskProgressScreenState
    extends State<CROParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.croselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.crotaskId}");
                DatabaseHelper().updateCROtask(
                  SeoTaskModel(
                    id: Helper.crotaskId,
                    taskname: Helper.croselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.crosnumber,
