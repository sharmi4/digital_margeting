...
import 'cro_statergy_screen.dart';


class AddCROTaskScreen extends StatefulWidget {
  const AddCROTaskScreen({super.key});

  @override
  State<AddCROTaskScreen> createState() => _AddCROTaskScreenState();
}

class _AddCROTaskScreenState extends State<AddCROTaskScreen> {
  ...
  gettaskdb() async {
    crogettask = await DatabaseHelper().getCROdata();
                  ...
                  child: InputDecorator(
                    decoration: InputDecoration(
                      prefixIcon: Image.asset(
                        "assets/icons/Rectangle 24 (1).png",
                      ),
                      border: InputBorder.none,
                    ),
                    child: Padding(
      ...
      bottomNavigationBar: Padding(
        ...
        child: InkWell(
          onTap: () async {
            ...
            await DatabaseHelper().insertCROtaskdata(addTask);
            Get.to(CROStrategyScreen(businessId: Helper.businessId));
          },
          child: Container(
            height: 50,
