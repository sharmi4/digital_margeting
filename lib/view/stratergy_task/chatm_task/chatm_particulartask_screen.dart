...
class CHATMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<CHATMParticulartaskProgressScreen> createState() =>
      _CHATMParticulartaskProgressScreenState();
}

class _CHATMParticulartaskProgressScreenState
    extends State<CHATMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.chatmselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.chatmtaskId}");
                DatabaseHelper().updateCHATMtask(
                  SeoTaskModel(
                    id: Helper.chatmtaskId,
                    taskname: Helper.chatmselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.chatmsnumber,
