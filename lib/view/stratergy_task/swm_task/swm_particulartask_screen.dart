...
class SWMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<SWMParticulartaskProgressScreen> createState() =>
      _SWMParticulartaskProgressScreenState();
}

class _SWMParticulartaskProgressScreenState
    extends State<SWMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.Smmselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.swmtaskId}");
                DatabaseHelper().updateSWMtask(
                  SeoTaskModel(
                    id: Helper.swmtaskId,
                    taskname: Helper.swmselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.swmsnumber,
