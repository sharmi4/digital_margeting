...
class RRParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<RRParticulartaskProgressScreen> createState() =>
      _RRParticulartaskProgressScreenState();
}

class _RRParticulartaskProgressScreenState
    extends State<RRParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.rrselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.rrtaskId}");
                DatabaseHelper().updateRRtask(
                  SeoTaskModel(
                    id: Helper.rrtaskId,
                    taskname: Helper.rrselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.rrsnumber,
