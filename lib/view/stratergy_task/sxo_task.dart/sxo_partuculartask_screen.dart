...
class SXOParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<SXOParticulartaskProgressScreen> createState() =>
      _SXOParticulartaskProgressScreenState();
}

class _SXOParticulartaskProgressScreenState
    extends State<SXOParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.sxoselectedstartergytitle,
              style: primaryFont(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                ...
                DatabaseHelper().updateSXOtask(
                  SeoTaskModel(
                    id: Helper.sxotaskId,
                    taskname: Helper.sxoselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.sxosnumber,
