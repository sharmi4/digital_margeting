...
import 'im_statergy_screen.dart';



class AddIMTaskScreen extends StatefulWidget {
  const AddIMTaskScreen({super.key});

  @override
  State<AddIMTaskScreen> createState() => _AddIMTaskScreenState();
}

class _AddIMTaskScreenState extends State<AddIMTaskScreen> {
  ...
  gettaskdb() async {
    imgettask = await DatabaseHelper().getIMdata();
  ...
  child: GestureDetector(
    ...
    child: Container(
     ...
     await DatabaseHelper().insertIMtaskdata(addTask);
      Get.to(IMStrategyScreen(businessId: Helper.businessId,));
