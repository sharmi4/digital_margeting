...
class IMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<IMParticulartaskProgressScreen> createState() =>
      _IMParticulartaskProgressScreenState();
}

class _IMParticulartaskProgressScreenState
    extends State<IMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.imselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.imtaskId}");
                DatabaseHelper().updateIMtask(
                  SeoTaskModel(
                    id: Helper.imtaskId,
                    taskname: Helper.imselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.imsnumber,
