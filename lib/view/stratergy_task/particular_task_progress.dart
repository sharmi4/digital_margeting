...
class ParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<ParticulartaskProgressScreen> createState() =>
      _ParticulartaskProgressScreenState();
}

class _ParticulartaskProgressScreenState
    extends State<ParticulartaskProgressScreen> {
  @override
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                ...
                DatabaseHelper().updateseotask(
                  SeoTaskModel(
                    id: Helper.taskId,
                    taskname: Helper.selectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.snumber,
