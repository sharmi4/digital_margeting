...
class CMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<CMParticulartaskProgressScreen> createState() =>
      _CMParticulartaskProgressScreenState();
}

class _CMParticulartaskProgressScreenState
    extends State<CMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.cmselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.cmtaskId}");
                DatabaseHelper().updateCMtask(
                  SeoTaskModel(
                    id: Helper.cmtaskId,
                    taskname: Helper.cmselectedstartergytitle,
