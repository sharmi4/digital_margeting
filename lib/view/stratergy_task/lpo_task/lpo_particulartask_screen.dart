...
class LPOParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<LPOParticulartaskProgressScreen> createState() =>
      _LPOParticulartaskProgressScreenState();
}

class _LPOParticulartaskProgressScreenState
    extends State<LPOParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.lposelectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.lpotaskId}");
                DatabaseHelper().updateLPOtask(
                  SeoTaskModel(
                    id: Helper.lpotaskId,
                    taskname: Helper.lposelectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.lposnumber,
