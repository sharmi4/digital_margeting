...
class VMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<VMParticulartaskProgressScreen> createState() =>
      _VMParticulartaskProgressScreenState();
}

class _VMParticulartaskProgressScreenState
    extends State<VMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.vmselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.vmtaskId}");
                DatabaseHelper().updateVMtask(
                  SeoTaskModel(
                    id: Helper.vmtaskId,
                    taskname: Helper.vmselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.vmsnumber,
