...
class EMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<EMParticulartaskProgressScreen> createState() =>
      _EMParticulartaskProgressScreenState();
}

class _EMParticulartaskProgressScreenState
    extends State<EMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.emselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.emtaskId}");
                DatabaseHelper().updateEMtask(
                  SeoTaskModel(
                    id: Helper.emtaskId,
                    taskname: Helper.emselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.emsnumber,
