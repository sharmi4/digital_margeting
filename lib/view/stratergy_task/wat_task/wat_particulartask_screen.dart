...
class WATParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<WATParticulartaskProgressScreen> createState() =>
      _WATParticulartaskProgressScreenState();
}

class _WATParticulartaskProgressScreenState
    extends State<WATParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.watselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.wattaskId}");
                DatabaseHelper().updateWATtask(
                  SeoTaskModel(
                    id: Helper.wattaskId,
                    taskname: Helper.watselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.watsnumber,
