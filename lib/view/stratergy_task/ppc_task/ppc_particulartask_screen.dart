...
class PPCParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<PPCParticulartaskProgressScreen> createState() =>
      _PPCParticulartaskProgressScreenState();
}

class _PPCParticulartaskProgressScreenState
    extends State<PPCParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.ppcselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.ppctaskId}");
                DatabaseHelper().updatePPCtask(
                  SeoTaskModel(
                    id: Helper.ppctaskId,
                    taskname: Helper.ppcselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.ppcsnumber,
