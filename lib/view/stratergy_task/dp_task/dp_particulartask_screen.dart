...
class DPParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<DPParticulartaskProgressScreen> createState() =>
      _DPParticulartaskProgressScreenState();
}

class _DPParticulartaskProgressScreenState
    extends State<DPParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.dpselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.dptaskId}");
                DatabaseHelper().updateDPtask(
                  SeoTaskModel(
                    id: Helper.dptaskId,
                    taskname: Helper.dpselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.cmsnumber,
