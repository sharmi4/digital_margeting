...
class AMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<AMParticulartaskProgressScreen> createState() =>
      _AMParticulartaskProgressScreenState();
}

class _AMParticulartaskProgressScreenState
    extends State<AMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.amselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.amtaskId}");
                DatabaseHelper().updateAMtask(
                  SeoTaskModel(
                    id: Helper.amtaskId,
                    taskname: Helper.amselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.amsnumber,
