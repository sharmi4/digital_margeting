...
import 'orm_statergy_screen.dart';

class AddORMTaskScreen extends StatefulWidget {
  const AddORMTaskScreen({super.key});

  @override
  State<AddORMTaskScreen> createState() => _AddORMTaskScreenState();
}

class _AddORMTaskScreenState extends State<AddORMTaskScreen> {
  ...
  gettaskdb() async {
    ormgettask = await DatabaseHelper().getORMdata();
    print(">>>>>>>>>>>>getemTask>>>>>>>${ormgettask.length}");
    setState(() {});
  }
      ...
      bottomNavigationBar: Padding(
        ...
        child: InkWell(
          onTap: () async {
            ...
            await DatabaseHelper().insertORMtaskdata(addTask);
            Get.to(ORMStrategyScreen(businessId: Helper.businessId));
          },
          child: Container(
            height: 50,
