...
class ORMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<ORMParticulartaskProgressScreen> createState() =>
      _ORMParticulartaskProgressScreenState();
}

class _ORMParticulartaskProgressScreenState
    extends State<ORMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.ormselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.ormtaskId}");
                DatabaseHelper().updateORMtask(
                  SeoTaskModel(
                    id: Helper.ormtaskId,
                    taskname: Helper.ormselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.ormsnumber,
