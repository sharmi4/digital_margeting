...
class LSParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<LSParticulartaskProgressScreen> createState() =>
      _LSParticulartaskProgressScreenState();
}

class _LSParticulartaskProgressScreenState
    extends State<LSParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.lsselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.lstaskId}");
                DatabaseHelper().updateLStask(
                  SeoTaskModel(
                    id: Helper.lstaskId,
                    taskname: Helper.lsselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.lssnumber,
