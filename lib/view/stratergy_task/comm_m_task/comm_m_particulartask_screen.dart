...
class CommunityMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<CommunityMParticulartaskProgressScreen> createState() =>
      _CommunityMParticulartaskProgressScreenState();
}

class _CommunityMParticulartaskProgressScreenState
    extends State<CommunityMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.commumselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.commumtaskId}");
                DatabaseHelper().updateCOMMUMtask(
                  SeoTaskModel(
                    id: Helper.commumtaskId,
                    taskname: Helper.commumselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.commumsnumber,
