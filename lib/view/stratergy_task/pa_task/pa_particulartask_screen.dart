...
class PAParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<PAParticulartaskProgressScreen> createState() =>
      _PAParticulartaskProgressScreenState();
}

class _PAParticulartaskProgressScreenState
    extends State<PAParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.paselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.pataskId}");
                DatabaseHelper().updatePAtask(
                  SeoTaskModel(
                    id: Helper.pataskId,
                    taskname: Helper.paselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.pasnumber,
