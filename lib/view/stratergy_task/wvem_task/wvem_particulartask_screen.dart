...
class WVEMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<WVEMParticulartaskProgressScreen> createState() =>
      _WVEMParticulartaskProgressScreenState();
}

class _WVEMParticulartaskProgressScreenState
    extends State<WVEMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.wvemselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.wvemtaskId}");
                DatabaseHelper().updateWVEMtask(
                  SeoTaskModel(
                    id: Helper.wvemtaskId,
                    taskname: Helper.wvemselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.wvemsnumber,
