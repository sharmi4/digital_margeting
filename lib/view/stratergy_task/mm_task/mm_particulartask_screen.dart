...
class MMParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<MMParticulartaskProgressScreen> createState() =>
      _MMParticulartaskProgressScreenState();
}

class _MMParticulartaskProgressScreenState
    extends State<MMParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.mmselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.mmtaskId}");
                DatabaseHelper().updateMMtask(
                  SeoTaskModel(
                    id: Helper.mmtaskId,
                    taskname: Helper.mmselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.mmsnumber,
