...
class MAParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<MAParticulartaskProgressScreen> createState() =>
      _MAParticulartaskProgressScreenState();
}

class _MAParticulartaskProgressScreenState
    extends State<MAParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.maselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.mataskId}");
                DatabaseHelper().updateMAtask(
                  SeoTaskModel(
                    id: Helper.mataskId,
                    taskname: Helper.maselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.masnumber,
