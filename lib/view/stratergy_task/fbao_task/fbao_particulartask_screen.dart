...
class FBAOParticulartaskProgressScreen extends StatefulWidget {
  String instructions;
  String type;
  String category;
  ...
  @override
  State<FBAOParticulartaskProgressScreen> createState() =>
      _FBAOParticulartaskProgressScreenState();
}

class _FBAOParticulartaskProgressScreenState
    extends State<FBAOParticulartaskProgressScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(
              Helper.fbaoselectedstartergytitle,
              style: primaryFont(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                print("TASK ID ==== > ${ Helper.fbaotaskId}");
                DatabaseHelper().updateFBAOtask(
                  SeoTaskModel(
                    id: Helper.fbaotaskId,
                    taskname: Helper.fbaoselectedstartergytitle,
                    insturctions: widget.instructions,
                    iscompleted: 1,
                    snumber: Helper.fbaosnumber,
